...
insert into public.distributors (company, city, discount, credit_limit, phone) values
 ...
 ('Almaty Demo',       'Алматы',    0.40, 4000000,  '');
...
join (values
 ...
 ('Сабитова Нұртас',40000000),('Рахманов',25000000),('Almaty Demo',12000000)
...
src as (
  ...
  join (values
   ...
   ('Сабитова Нұртас',2831901),('Рахманов',2307519),('Almaty Demo',0)
...
src as (
  ...
  join (values
   ...
   ('Рахманов',4757681),('Almaty Demo',2300000)
  ) v(company, amount) on v.company = d.company
),
ins as (
  insert into public.orders (distributor_id, status, created_at)
